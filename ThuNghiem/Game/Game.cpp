...
bool Game::Init() //Định nghĩa hàm khởi tạo của lớp Game
{
    ...
    */
    ...
    window = SDL_CreateWindow("Breakout Game"/*Đây là tên của sổ*/,
                              SDL_WINDOWPOS_CENTERED/*Căn giữa ngang*/, SDL_WINDOWPOS_CENTERED/*Căn giữa dọc*/,
                              800/*Rộng 800pixels*/, 600/*Cao pixels*/, SDL_WINDOW_SHOWN /*Hằng số làm cửa sổ hiển thị*/| SDL_WINDOW_OPENGL/*Hằng số làm của sổ có đồ họa 2D*/);
    if (!window) //Nếu ko mở
    {
    ...
    SDL_Surface* surface = IMG_Load("test.png"); //IMG_Load AKA Image load là hàm thuộc SDL_Image để lấy hình ảnh từ file cái SDL_Surface dùng để lưu trũ thôi, dùng texture cho nó tối ưu
