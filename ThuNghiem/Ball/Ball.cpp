...
void Ball::Update(float delta)
{
    ...
    */
    y += HuongY * delta;//tương tự dòng trên
}
...
void Ball::SetDirection(float HuongX, float HuongY)
{
    float length = sqrt(HuongX * HuongX + HuongY * HuongY);
    //Chiều dài đường đi giữa 2 tọa độ
    this->HuongX = tocDoBong * (HuongX / length);
    ...
    */
    this->HuongY = tocDoBong * (HuongY/ length);
    /*tương tự*/
}
